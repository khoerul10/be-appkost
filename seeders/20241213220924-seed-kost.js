  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('kost', [
      ...
      },
      {
        ...
        keamanan_id: Math.floor(Math.random() * 5) + 1,
        photos: JSON.stringify([
          'https://res.cloudinary.com/ksarifudin/image/upload/v1734583303/kost_photos/kost_default.png',
        ]),
        thumb_image: 'https://res.cloudinary.com/ksarifudin/image/upload/v1734583303/kost_photos/kost_default.png',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
